...
class LittleJWT
{
     ...
     *
     * @param JWT $jwt JWT instance to validate (generated by parseToken() method)
     * @param callable $callback Callback that receives Validatable to set checks for JWT.
     ...
     * @param callable $callback Callback that receives Validator to set checks for JWT.
     * @return bool True if token is valid.
     */
